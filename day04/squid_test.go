...
func Test__RunDiagnostics_PartOne(t *testing.T) {
	expected := 4512
	actual := bingoPartOne(testInput4)
...
func Test__RunDiagnostics_PartTwo(t *testing.T) {
	expected := 4512
	actual := bingoPartTwo(testInput4)
